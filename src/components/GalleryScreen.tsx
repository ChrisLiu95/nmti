    ...
    <div className="screen gallery-screen">
      <div className="gallery-content">
        <div className="gallery-header">
          ...
          <h2 className="gallery-title">牛马花名册</h2>
          <span className="gallery-count">{personalities.length} 种命运</span>
        </div>
        ...
        <div className="gallery-special-label">隐藏牛马（触发条件保密）</div>
